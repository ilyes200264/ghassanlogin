            ...
            <CardContent className="space-y-6 pb-6">
              <Auth
                ...
                appearance={{
                  ...
                  className: {
                    container: 'space-y-4',
                    button: 'mt-2 h-11 min-h-[44px] w-full bg-white text-black hover:bg-white/90 border border-border rounded-lg shadow-sm focus:ring-2 focus:ring-primary/20 focus:outline-none font-semibold',
                    input: 'h-11 bg-white text-black border border-border rounded-lg focus:ring-2 focus:ring-primary/30 placeholder:text-muted-foreground',
                    label: 'text-foreground',
                    anchor: 'text-black hover:underline',
                    loader: 'text-primary',
                  },
                }}
                providers={[]}
